...
from resnet import * # own resnet implementation folder
...
### Crop images to be 224 x 224, which is important to match the required input sizes of the ResNet model! ###
data_transforms = {
...
# Make a training model that processes the data -- resnet
